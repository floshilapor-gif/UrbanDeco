...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    description:
      "Un sofá que abraza. El Roma combina un tapizado en velvet color borgoña, brazos contenidos y un asiento profundo de almohadones desenfundables. La elegancia clásica reinterpretada para el living contemporáneo.",
    features: [
      "Tapizado velvet borgoña de gran densidad",
      "Asiento profundo con espuma HR",
      "Almohadones desenfundables",
      "Estructura de madera maciza",
    ],
    dimensions: "260 × 100 × 80 cm",
    colors: ["Borgoña", "Verde inglés", "Azul noche"],
    badge: "Nuevo",
    gallery: [
      { src: "/images/sillonroma.jpeg" },
      { src: "/images/sillonromaa.jpeg" },
    ],
  },
  {
    ...
    description:
      "Versatilidad pura. El París tiene un asiento retráctil que se extiende para convertirse en chaise lounge cuando quieras estirar las piernas. Tapizado en tela sage de tacto natural, con respaldo reclinable.",
    features: [
      "Asiento retráctil con extensión a chaise",
      "Respaldo reclinable manualmente",
      "Tela texturada color sage",
      "Patas ocultas con apoyo continuo",
    ],
    dimensions: "230 × 100 × 80 cm (cerrado)",
    colors: ["Sage", "Gris claro", "Beige"],
    badge: "Nuevo",
    gallery: [
      { src: "/images/sillonretractilparis.jpeg" },
      { src: "/images/sillonretractilpariss.jpeg" },
    ],
  },
  {
    slug: "sillon-ibiza",
    ...
    description:
      "Para los que reciben en grande. El Ibiza es un seccional modular de líneas profundas con configuración en L, tapizado en tweed color taupe que combina con todo. Pensado para los livings amplios donde el confort manda.",
    features: [
      "Configuración modular en L",
      "Tapizado en tweed taupe resistente",
      "Asiento amplio con espuma HR",
      "Almohadones decorativos incluidos",
    ],
    dimensions: "390 × 245 × 75 cm",
    colors: ["Taupe", "Crema", "Antracita"],
    badge: "Nuevo",
    gallery: [{ src: "/images/sillonibiza.jpeg" }],
  },
  {
    slug: "sillon-megan",
    name: "Sillón Megan",
    ...
    description:
      "Confort sin pretensiones. El Megan tiene un asiento bajo, profundo y un respaldo relajado, tapizado en tweed color oatmeal que aporta calidez sin estridencia. Ideal para livings modernos y minimalistas.",
    features: [
      "Asiento bajo y profundo",
      "Tela tweed oatmeal cálida",
      "Líneas amplias y minimalistas",
      "Almohadones lumbares incluidos",
    ],
    dimensions: "270 × 105 × 70 cm",
    colors: ["Oatmeal", "Gris perla", "Avena"],
    badge: "Nuevo",
    gallery: [
      { src: "/images/sillonmegannnn.jpeg" },
      { src: "/images/sillonmegan1.jpeg" },
      { src: "/images/sillonmegann.jpeg" },
      { src: "/images/sillonmegannnnn.jpeg" },
    ],
  },
  {
    slug: "sillon-moscu",
    ...
    description:
      "Dramatismo elegante. El Moscú es un seccional de 3 plazas con chaise lounge integrada, tapizado en velvet antracita que aporta profundidad y carácter. Patas metálicas negras puntiagudas para un toque industrial-chic.",
    features: [
      "Seccional 3 plazas + chaise",
      "Tapizado velvet color antracita",
      "Patas metálicas negras puntiagudas",
      "Asientos con espuma de alta densidad",
    ],
    dimensions: "290 × 165 × 80 cm",
    colors: ["Antracita", "Verde botella", "Bordeaux"],
    badge: "Nuevo",
    gallery: [
      { src: "/images/sillonmoscuu.jpeg" },
      { src: "/images/sillonmoscuiuu.jpeg" },
    ],
  },
  {
